                                    ...
                                    <table class="table align-middle" id="customerTable">
                                        ...
                                        <tbody class="list form-check-all">
                                            @foreach ($users as $user)
                                                    ...
                                                    <td>
                                                        <ul class="list-inline hstack gap-2 mb-0">
                                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                ...
                                                                title="View">
                                                                <a href="{{ url('admin/user/' . $user->unique_id) }}"
                                                            ...
                                                            <li class="list-inline-item edit" data-bs-toggle="tooltip"
                                                                data-bs-trigger="hover" data-bs-placement="top"
                                                                title="Edit">
                                                                <a href="#showModal{{ $user->unique_id }}"
                                                            ...
                                                            <li class="list-inline-item" data-bs-toggle="tooltip"
                                                                ...
                                                                <a class="text-danger d-inline-block remove-item-btn"
                                                                    data-bs-toggle="modal"
                                                                    href="#deleteModal{{ $user->unique_id }}">
                                                ...
                                                <div class="modal fade flip" id="deleteModal{{ $user->unique_id }}"
                                                    tabindex="-1" aria-hidden="true">
                                                    @include('admins.user.delete')
                                                </div>
                                                <div class="modal fade zoomIn" id="showModal{{ $user->unique_id }}"
