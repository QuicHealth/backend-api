                ...
                <div class="row gy-4 mb-3">
                    <div class="col-md-6">
                        <div>
                            ...
                            <input type="text" name="firstname" id="amount-field" class="form-control" placeholder="First Name" required />
                            @error('firstname')
                    ...
                    <div class="col-md-6">
                        <div>
                            ...
                            <input type="text" name="lastname" id="amount-field" class="form-control" placeholder="Last Name" required />
                            @error('lastname')
                                <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
