        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Hospital Payout</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Financial Managment</a></li>
                            <li class="breadcrumb-item active">Hospital Payout</li>
                        </ol>
                    </div>
                                ...
                                <table class="table align-middle" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="sort" data-sort="name">Hospital Name</th>
                                            <th class="sort" data-sort="leads_score">Hospital Email</th>
