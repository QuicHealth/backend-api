        ...
        <form action="{{ url('admin/admin/add') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="customername-field" value="{{ $admin->username }}" class="form-control" placeholder="Enter Name" required />
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" id="customername-field" value="{{ $admin->username }}" class="form-control" placeholder="Enter Email" required />
                    @error('email')
                        <p class="text-danger">{{$message}}</p>
                    @enderror
                </div>
