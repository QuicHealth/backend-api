<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <form action="{{ url('admin/doctor/add') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" data-trigger name="hospital" id="payment-field" required>
