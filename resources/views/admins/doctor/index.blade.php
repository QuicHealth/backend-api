                                ...
                                <table class="table align-middle" id="customerTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        @foreach ($doc as $docs)
                                                ...
                                                <td>
                                                    <ul class="list-inline hstack gap-2 mb-0">
                                                        <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                            <a href="{{ url('admin/doctor/'. $docs->id) }}" class="text-primary d-inline-block">
                                                                <i class="ri-eye-fill fs-16"></i>
                                                            </a>
                                                        </li>
                                                        <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                            <a href="#showModal{{ $docs->id }}" data-bs-toggle="modal" class="text-primary d-inline-block edit-item-btn">
                                            ...
                                            <div class="modal fade flip" id="deleteOrder{{ $docs->id }}" tabindex="-1" aria-hidden="true">
                                                @include('admins.doctor.delete')
                                            </div>
                                            <div class="modal fade zoomIn" id="showModal{{ $docs->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
