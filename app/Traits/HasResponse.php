...
trait HasResponse
{
    ...
    public function failedResponse($message, array $data = []): JsonResponse
    {
        $response = [
            ...
            'statuscode' => config('quichealth.code.failed'),
            'message' => $message
        ];
    ...
    {
        $response = [
            'status' => config('quichealth.status.success'),
            'statuscode' => config('quichealth.code.success'),
            'message' => $message
        ];
    ...
    public function serverErrorResponse($message, Exception $exception = null): JsonResponse
    {
        ...
        $response = [
            'status' => config('quichealth.status.failed'),
            'statuscode' => config('quichealth.code.server_error'),
            'message' => $message,
        ];
    ...
    public function notFoundResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('quichealth.status.failed'),
            'statuscode' => config('quichealth.code.not_found'),
            'message' => $message
        ];
    ...
    public function notAllowedResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('quichealth.status.failed'),
            'statuscode' => config('quichealth.code.not_allowed'),
            'message' => $message
        ];
    ...
    public function notExistResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('quichealth.status.failed'),
            'statuscode' => config('quichealth.code.notexist'),
            'message' => $message
        ];
    ...
    public function existsResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('quichealth.status.failed'),
            'statuscode' => config('quichealth.code.exists'),
            'message' => $message
        ];
    ...
    public function networkErrorResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('quichealth.status.failed'),
            'statuscode' => config('quichealth.code.network_error'),
            'message' => $message
        ];
    ...
    public function badRequestResponse($message, array $data = []): JsonResponse
    {
        $response = [
            'status' => config('quichealth.status.failed'),
            'statuscode' => config('quichealth.code.bad_request'),
            'message' => $message
        ];
